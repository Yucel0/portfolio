  ...
  return (
    <main className="container mx-auto flex items-center justify-between content max-[767px]:max-w-full max-[767px]:px-4 max-[575px]:flex-col max-[575px]:gap-6 max-[575px]:justify-center">
      <section className="flex flex-col gap-4 max-[575px]:order-2">
        ...
        <Link className="w-[180px] bg-[#ff642d] rounded-[50px] h-10 text-base text-white hover:border hover:border-solid hover:border-[#ff642d] hover:bg-white hover:text-[#ff642d] transition ease-linear duration-200 tracking-[.3px] flex justify-center items-center gap-1" href='/about'>
          Hakkımda
          <IoNavigateCircle />
        </Link>
        <Social />
